...
def process_file(file_path):
    ...
    #separete normal and abnormal traces in this time window
    abnormal_traces = []
    normal_traces = []
    ...
    #print(len(abnormal_traces), len(normal_traces))
   ...
   #####################################################Step 3: Apply PageRank based on communities#####################################################
    ...
    return root_cause,ranked_list_of_candiates,(toc-tic),memory_usage,cpu_percent
...
def local_combinational_Page_rank3(graph, communities):
    node_scores={}
    #calculate node pagerank inside of communities*community score.
