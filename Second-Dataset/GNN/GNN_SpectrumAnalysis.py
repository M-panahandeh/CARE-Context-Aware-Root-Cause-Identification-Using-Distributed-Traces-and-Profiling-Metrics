...
def process_file(file_path):
   ...
   #####################################################Step 3: Apply PageRank based on communities#####################################################
    ...
    print("time:",(toc-tic), "memory usage:", memory_usage,"CPU usage:", cpu_percent)
...
#calculate node score in the general graph * PR claculated for graph of communites
...
def local_combinational_Page_rank3(graph, communities):
    node_scores={}
    #calculate node pagerank inside of communities*community score. developed for heuristic communities
