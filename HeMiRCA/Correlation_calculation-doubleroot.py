...
SCORE_FILE = r"D:\HeMiRCA\vector\abnormal_trace_scores-mse.txt"
METRICS_DIR = r"D:\HeMiRCA\Metrics-generated"
FAULT_JSON = r"D:\HeMiRCA\double\InjectedFaults\injected_faults.json"
OUTPUT_FILE = "./correlation_result_spearman_mse-double.csv"
...
def load_and_prepare_metrics(file_path):
    ...
    cols_to_scale = [
        ...
        "memory_usage", "memory_working_set", "rx_bytes", "tx_bytes","latency"
    ]
